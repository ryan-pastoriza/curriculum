<?php
	...
	* 
	*/
	class Stud_load_cap_set extends CURRV_Model{
		public $table = 'stud_load_cap_set';
		public $primary_key  = 'slcs_id';
		public $fillable = array('slcs_id','student_type','unit_capacity');
		...
		{
			$this->as_object()->set_cache('stud_load_cap_set_list')->get_all();
		}
