<?php
	...
	* 
	*/
	class Plotted_time extends CURRV_Model{
		public $table = 'plotted_time';
		public $primary_key  = 'pt_id';
		public $fillable = array('time','st_id');
		...
		{
			$this->as_object()->set_cache('get_all_plotted_time')->get_all();
		}
