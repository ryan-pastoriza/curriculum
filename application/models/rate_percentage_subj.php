<?php
	...
	* 
	*/
	class Rate_percentage_subj extends CURRV_Model{
		public $table = 'rate_percentage_subj';
		public $primary_key  = 'rns_id';
		public $fillable = array('rate_num','subj_id','rn_id');
		...
		{
			$this->as_object()->set_cache('get_all_rate_percentage_subj_list')->get_all();
		}
