<?php
	...
	* 
	*/
	class Pre_requisite extends CURRV_Model{
		public $table = 'pre_requisite';
		public $primary_key  = 'prr_id';
		public $fillable = array('cs_id','subj_id');
		...
		public function __construct()
		{
			...
			$this->has_many['subjects'] =  array('subjects','subj_id','subj_id');
