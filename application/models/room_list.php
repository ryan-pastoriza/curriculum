<?php
	...
	* 
	*/
	class Room_list extends CURRV_Model{
		public $table = 'room_list';
		public $primary_key  = 'rl_id';
		public $fillable = array('room_code','room_name','capacity','location','type','desc');
		...
		{
			$this->as_object()->set_cache('get_all_room_list')->get_all();
		}
		...
		public function checkRoomCode($code='',$opt='')
		{
			
			$isValid = TRUE;
			if(isset($code) && $this->where('room_code',$code)->get() && $opt != 'edit'){
				$isValid = FALSE;
