<?php
	...
	* 
	*/
	class Year_sem extends CURRV_Model{
		public $table = 'year_sem';
		public $primary_key  = 'ys_id';
		public $fillable = array('cur_id','year','semister');
		...
		{
			$this->as_object()->set_cache('get_all_year_sem')->get_all();
		}
