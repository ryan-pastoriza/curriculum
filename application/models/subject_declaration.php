<?php
	...
	* 
	*/
	class Subject_declaration extends CURRV_Model{
		public $table = 'subject_declaration';
		public $primary_key  = 'sd_id';
		public $fillable = array('ss_id','declaration');
		...
		{
			$this->as_object()->set_cache('subject_declaration_list')->get_all();
		}
