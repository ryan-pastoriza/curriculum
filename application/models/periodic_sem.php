<?php
	...
	* 
	*/
	class Periodic_sem extends CURRV_Model{
		public $table = 'periodic_sem';
		public $primary_key  = 'ps_id';
		public $fillable = array('periodic_id','ss_id','date_start','date_end','created_at','updated_at');
		...
		{
			$this->as_object()->set_cache('periodic_sem_file')->get_all();
		}
