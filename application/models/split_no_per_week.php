<?php
	...
	* 
	*/
	class Split_no_per_week extends CURRV_Model{
		public $table = 'split_no_per_week';
		public $primary_key  = 'snpw_id';
		public $fillable = array('number','subj_id');
		...
		{
			$this->as_object()->set_cache('get_all_split_no_per_week_list')->get_all();
		}
