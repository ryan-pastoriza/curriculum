<?php
	...
	* 
	*/
	class Program_list extends CURRV_Model{
		public $table = 'sis_main_db.program_list';
		public $primary_key  = 'pl_id';
		public $fillable = array('prog_code','prog_abv','prog_name','prog_desc','prog_type','level','major','senior_high_track','dep_id','created_at','updated_at');
		...
		{
			$this->as_object()->set_cache('get_all_program_list')->get_all();
		}
		...
		public function fetchDataBy($level)
		{
			return $this->where('level',$level)->get_all();
		}
