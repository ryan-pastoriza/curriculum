<?php
	...
	* 
	*/
	class Curr_subject extends CURRV_Model{
		public $table = 'cur_subject';
		public $primary_key  = 'cs_id';
		public $fillable = array('subj_id','ys_id');
		...
		{
			$this->as_object()->set_cache('get_all_curr_subjects_list')->get_all();
		}
