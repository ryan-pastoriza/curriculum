<?php
	...
	* 
	*/
	class Periodic extends CURRV_Model{
		public $table = 'periodic';
		public $primary_key  = 'periodic_id';
		public $fillable = array('period');
		...
		{
			$this->as_object()->set_cache('periodic_file')->get_all();
		}
