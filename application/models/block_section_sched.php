<?php
	...
	* 
	*/
	class Block_section_sched extends CURRV_Model{
		public $table = 'block_section_sched';
		public $primary_key  = 'sched_id';
		public $fillable = array('bs_id','ss_id','sched_type');
		...
		{
			$this->as_object()->set_cache('get_all_block_section_sched_list')->get_all();
		}
