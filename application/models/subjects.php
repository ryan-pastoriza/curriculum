<?php
	...
	* 
	*/
	class Subjects extends CURRV_Model{
		public $table = 'subject';
		public $primary_key  = 'subj_id';
		public $fillable = array('subj_code','subj_name','subj_desc','lec_hour','lab_hour','lab_unit','split','subj_type','lec_unit');
		...
		{
			$this->as_object()->set_cache('get_all_subjects')->get_all();
		}
		...
		public function modify($subj_id,$data)
		{
