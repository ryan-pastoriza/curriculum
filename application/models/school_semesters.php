<?php
	...
	* 
	*/
	class School_semesters extends CURRV_Model{
		public $table = 'school_semester';
		public $primary_key  = 'ss_id';
		public $fillable = array('school_year','semester','date_start','date_end');
		...
		{
			$this->as_object()->set_cache('get_all_school_semester_list')->get_all();
		}
