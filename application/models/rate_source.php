<?php
	...
	* 
	*/
	class Rate_source extends CURRV_Model{
		public $table = 'rate_source';
		public $primary_key  = 'rn_id';
		public $fillable = array('rate_name','description');
		...
		{
			$this->as_object()->set_cache('get_all_rate_source')->get_all();
		}
