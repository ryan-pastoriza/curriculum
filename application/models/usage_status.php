<?php
	...
	* 
	*/
	class Usage_status extends CURRV_Model{
		public $table = 'sis_main_db.usage_status';
		public $primary_key  = 'us_id';
		public $fillable = array('status','pl_id');
		...
		{
			$this->as_object()->set_cache('usage_status_list')->get_all();
		}
