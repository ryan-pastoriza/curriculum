 ...
 *
 **/
class CURRV_Model extends CI_Model
{
    ...
    {  
       ...
       {  
            $this->db->like("subj_name", $_POST["search"]["value"]);  
            $this->db->or_like("subj_code", $_POST["search"]["value"]);  
       }  
       ...
       {  
            $this->db->order_by('subj_id', 'DESC');  
       }  
    }  
    public function make_datatables($column,$order_column)
    {  
       $this->column = $column;
